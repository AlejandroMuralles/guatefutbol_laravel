...
class PartidoRepo extends BaseRepo{
	...
	public function getByCampeonatosByFaseByEstado($campeonatosId, $fases, $estados)
	{
		return Partido::whereIn('campeonato_id',$campeonatosId)
						->with('equipo_local')
						->with('equipo_visita')
						->whereHas('jornada',function($q) use ($fases)
							{
	...
	public function getByCampeonatoByJornada($campeonatoId,$jornadaId)
	{
		$partidos = Partido::where('campeonato_id',$campeonatoId)
