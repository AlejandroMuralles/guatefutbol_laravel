...
<html>
    <head>
        ...
        <!-- Bootstrap 3.3.2 -->
        <link href="{{ asset('assets/public/css/plugins/bootstrap/css/bootstrap.css') }}" rel="stylesheet" type="text/css" />
        <link href="{{ asset('assets/public/css/style-blue.css') }}" rel="stylesheet" type="text/css" />
        <!-- Font Awesome Icons -->
